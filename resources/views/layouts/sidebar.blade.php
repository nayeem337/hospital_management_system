                    ...
                    <li class="nav-item has-treeview @if($c == 'lab-reports' || $c == 'lab-report-templates') menu-open @endif">
                        ...
                        <ul class="nav nav-treeview">
                            @canany(['lab-report-read', 'lab-report-create', 'lab-report-update', 'lab-report-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('medicien.add') }}" class="nav-link @if($c == 'lab-reports') active @endif">
                                        <i class="nav-icon fas fa-vial"></i>
                                        <p>@lang('Add Medicine')</p>
                                    </a>
                                </li>
                            @endcanany
                            @canany(['lab-report-template-read', 'lab-report-template-create', 'lab-report-template-update', 'lab-report-template-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('medicien.manage') }}" class="nav-link @if($c == 'lab-report-templates') active @endif">
                                        <i class="nav-icon fas fa-crop-alt"></i>
                                        <p>@lang('Manage Medicine')</p>
                                    </a>
                                </li>
                            @endcanany
                        </ul>
                ...
                @canany(['lab-report-read', 'lab-report-create', 'lab-report-update', 'lab-report-delete', 'lab-report-template-read', 'lab-report-template-create', 'lab-report-template-update', 'lab-report-template-delete'])
                    <li class="nav-item has-treeview @if($c == 'lab-reports' || $c == 'lab-report-templates') menu-open @endif">
                        ...
                        <ul class="nav nav-treeview">
                            @canany(['lab-report-read', 'lab-report-create', 'lab-report-update', 'lab-report-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('ipd-opd.create') }}" class="nav-link @if($c == 'lab-reports') active @endif">
                                        <i class="nav-icon fas fa-vial"></i>
                                        <p>@lang('Add Opd')</p>
                                    </a>
                                </li>
                            ...
                            @canany(['lab-report-template-read', 'lab-report-template-create', 'lab-report-template-update', 'lab-report-template-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('ipd-opd.index') }}" class="nav-link @if($c == 'lab-report-templates') active @endif">
                                        <i class="nav-icon fas fa-crop-alt"></i>
                                        <p>@lang('Manage Opd')</p>
                                    </a>
                                </li>
                ...
                @canany(['lab-report-read', 'lab-report-create', 'lab-report-update', 'lab-report-delete', 'lab-report-template-read', 'lab-report-template-create', 'lab-report-template-update', 'lab-report-template-delete'])
                    <li class="nav-item has-treeview @if($c == 'lab-reports' || $c == 'lab-report-templates') menu-open @endif">
                        ...
                        <ul class="nav nav-treeview">
                            @canany(['lab-report-read', 'lab-report-create', 'lab-report-update', 'lab-report-delete'])
                                <li class="nav-item">
                                    <a href="{{route('diagnostic.add')}}" class="nav-link @if($c == 'lab-reports') active @endif">
                                        <i class="nav-icon fas fa-vial"></i>
                                        <p>@lang('Add  Diagnostic')</p>
                                    </a>
                                </li>
                            @endcanany
                            @canany(['lab-report-template-read', 'lab-report-template-create', 'lab-report-template-update', 'lab-report-template-delete'])
                                <li class="nav-item">
                                    <a href="{{route('diagnostic.manage')}}" class="nav-link @if($c == 'lab-report-templates') active @endif">
                                        <i class="nav-icon fas fa-crop-alt"></i>
                                        <p>@lang('Manage Diagnostic')</p>
                                    </a>
                                </li>
                            @endcanany
                        </ul>
...
{{--End  diagnostic--}}
                ...
                @canany(['lab-report-read', 'lab-report-create', 'lab-report-update', 'lab-report-delete', 'lab-report-template-read', 'lab-report-template-create', 'lab-report-template-update', 'lab-report-template-delete'])
                    <li class="nav-item has-treeview @if($c == 'lab-reports' || $c == 'lab-report-templates') menu-open @endif">
                        ...
                        <ul class="nav nav-treeview">
                            @canany(['lab-report-read', 'lab-report-create', 'lab-report-update', 'lab-report-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('billinvoice.add') }}" class="nav-link @if($c == 'lab-reports') active @endif">
                                        <i class="nav-icon fas fa-vial"></i>
                                        <p>@lang('Add Bill Invoice')</p>
                                    </a>
                                </li>
                            @endcanany
                            @canany(['lab-report-template-read', 'lab-report-template-create', 'lab-report-template-update', 'lab-report-template-delete'])
                                <li class="nav-item">
                                    <a href="{{ route('billinvoice.manage') }}" class="nav-link @if($c == 'lab-report-templates') active @endif">
                                        <i class="nav-icon fas fa-crop-alt"></i>
                                        <p>@lang('Manage Bill Invoice')</p>
                                    </a>
                                </li>
                            @endcanany
                        </ul>
      ...
      {{--Start  Country--}}
                                ...
                                @canany(['lab-report-read', 'lab-report-create', 'lab-report-update', 'lab-report-delete', 'lab-report-template-read', 'lab-report-template-create', 'lab-report-template-update', 'lab-report-template-delete'])
                                    <li class="nav-item has-treeview @if($c == 'lab-reports' || $c == 'lab-report-templates') menu-open @endif">
                                        ...
                                        <ul class="nav nav-treeview">
                                            @canany(['lab-report-read', 'lab-report-create', 'lab-report-update', 'lab-report-delete'])
                                                <li class="nav-item">
                                                    <a href="{{route('country.add')}}" class="nav-link @if($c == 'lab-reports') active @endif">
                                                        <i class="nav-icon fas fa-vial"></i>
                                                        <p>@lang('Add country')</p>
                                                    </a>
                                                </li>
                                            @endcanany
                                            @canany(['lab-report-template-read', 'lab-report-template-create', 'lab-report-template-update', 'lab-report-template-delete'])
                                                <li class="nav-item">
                                                    <a href="{{route('country.manage')}}" class="nav-link @if($c == 'lab-report-templates') active @endif">
                                                        <i class="nav-icon fas fa-crop-alt"></i>
                                                        <p>@lang('Manage country')</p>
                                                    </a>
                                                </li>
                                            @endcanany
                                        </ul>
                            ...
                            @if($roleName['0'] == "Super Admin")
                                <!--<li class="nav-item">-->
                                <!--    <a href="{{ route('update.index') }}" class="nav-link @if($c == 'update') active @endif ">-->
