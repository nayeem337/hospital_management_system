...
@section('content')
    ...
    <div class="container mt-5">
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                <form  action="{{route('ipd-opd.update',$data->id)}}" method="POST">
                    @csrf
                    @method('PUT');
                    @php
                    ...
                    <div class="col-md-12">
                        <div class='row'>
                            ...
                            <div class='col-md-6'>
                                ...
                                <input type="date" id="fname" class="form-control" name="date" value="{{$data->date}}">
                            </div>
                            <div class='col-md-6'>
                                <label for="fname">Id Card No/Designation:</label><br>
                                <input type="text" id="fname" class="form-control" value="{{$data->card_no}}" name="card_no">
                            </div>
                            <div class='col-md-6'>
                                <label for="fname">Hospital Name:</label><br>
                                <select class="form-control" id="toadd" name="hospital_name" value="">
...
.
                        ...
                        <button type="submit" class="btn btn-success waves-effect waves-light text-white">Update Opd</button>
                </form>
            </div>
        </div>
    </div>
