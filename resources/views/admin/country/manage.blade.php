                    ...
                    @foreach($countries as $country)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('country.edit',['id' => $country->id])}}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-eye ambitious-padding-btn"></i></a>&nbsp;&nbsp;
                                @can('doctor-schedule-delete')
                                    <a href="{{route('country.delete',['id' => $country->id])}}" data-href="" class="btn btn-info btn-outline btn-circle btn-lg" onclick="return confirm('Are you want to sure to delete this!');"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                @endcan
                            </td>
                        </tr>
                    @endforeach
