...
class PatientDetailController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $userData = $request->only(['name','email','phone','address','gender','blood_group','status','nationality','user_type']);
...
//        dd($userData );
    ...
    public function update(Request $request, User $patientDetail)
    {
        ...
        $userData = $request->only(['name','email','phone','address','gender','nationality','user_type','blood_group','status',]);
        if ($request->password)
            $userData['password'] = bcrypt($request->password);
